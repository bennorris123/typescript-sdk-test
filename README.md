...
```sh
npm install git+ssh://git@github.com:relax-ai/typescript-sdk-test.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/relax-ai/typescript-sdk-test/issues) with questions, bugs, or suggestions.
